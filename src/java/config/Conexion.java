...
public class Conexion {
    ...
    public Connection connect() {
        ...
        try {
            ...
            try {
                conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestion_evento?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true", "root", "root");
                if (conexion != null) {
